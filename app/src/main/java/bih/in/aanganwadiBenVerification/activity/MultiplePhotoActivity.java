...
public class MultiplePhotoActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor cursor = db
                .rawQuery(
                        "SELECT photo,Photo1 FROM PlantationDetail where InspectionID =?",
            ...
            switch (i) {
                ...
                case 1:
                    if (imageData2!=null) {
                        ...
                        whereArgs = new String[]{String.valueOf(PID)};
                        db.update("PlantationDetail", values, "InspectionID=?", whereArgs);
                    }
                    break;
//                case 2:
//                    if (imageData3!=null) {
...
//                        whereArgs = new String[]{String.valueOf(PID)};
//                        long c1= db.update("PondInspectionDetail", values, "id=?", whereArgs);
//                        if(c1>0)
//                        {
//                            Log.e("IMAGEE","Updated");
//                        }
...
//                        whereArgs = new String[]{String.valueOf(PID)};
//                        db.update("PondInspectionDetail", values, "id=?", whereArgs);
//                    }
//                    break;
    ...
    public void onBackPressed() {
        //if (purpose.equalsIgnoreCase("new")){
            if (exitCount < 4){
                ...
                long isDel = db.resetPlantationInspectionUpdatedData(String.valueOf(PID));
                finish();
            }
        //}else{
            //finish();
