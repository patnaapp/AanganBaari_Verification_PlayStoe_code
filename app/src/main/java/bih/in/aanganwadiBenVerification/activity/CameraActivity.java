...
public class CameraActivity extends Activity
{
    ...
    private void locationManager()
    {
        if (GlobalVariables.glocation == null)
        {
            ...
            mlocManager.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, 5000, 10, mlistener);
        }
        else
        {
    ...
    private final LocationListener mlistener = new LocationListener()
    {
        ...
        public void onLocationChanged(Location location)
        {
            ...
            if(!isMockLocationOn(location, CameraActivity.this))
            {
...
//                }
                ...
                new AlertDialog.Builder(CameraActivity.this)
                        ...
                        .setTitle("चेतावनी!")
                        .setMessage("कृपया Mock Location को developer option से disable करें और Fake Location App को बंद करें")
                        .setCancelable(false)
